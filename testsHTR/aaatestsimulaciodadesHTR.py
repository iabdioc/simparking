...
sys.path.append("..")
#from simulacio_dades.simulacio_dades import generar_caps_de_setmana, generar_matricules, generar_matricules_png
from simulacio_dades.simulacio_dades import *

from datetime import datetime, timedelta

class TestSimulacio(unittest.TestCase):
